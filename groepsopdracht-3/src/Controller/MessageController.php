...
class MessageController extends AbstractController
{
    ...
    public function index()
    {
        ...
        foreach ($messages as $message) {
            if ($userId == $message->getUserId() || $userRole == "ROLE_MOD") {
    ...
    public function searchMessage(Request $request, PaginatorInterface $paginator)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $query = $em->getRepository(Message::class)
                ->findBySearch($search);
        ...
        return $this->render('default/search.html.twig', array('pagination' => $pagination));
    }
    ...
    public function newComment(Request $request, $id)
    {
        ...
        return new Response($comment->getToken());
    }
}
